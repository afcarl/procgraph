...
index = {'packages': {'procgraph.components.debug_components': {'blocks': ['info',
              ...
              'procgraph_cv': {'blocks': ['gradient', 'smooth'],
                               'desc': 'Operations using the OpenCV library. ',
              ...
              'procgraph_foo': {'blocks': ['block_example'],
                                ...
                                'requires': {'pickle': ['cPickle',
                                                        'pickle']}},
              'procgraph_hdf': {'blocks': ['hdfread_test',
                                           'hdfwrite',
                                           'hdfread'],
                                'desc': 'This is a set of blocks to read and write logs in HDF5 format. ',
              ...
              'procgraph_images': {'blocks': ['rgb2gray',
                                   ...
                                   'requires': {}},
              'procgraph_io_misc': {'blocks': ['pickle_group',
                                               'to_file',
                                               'pickle',
                                               'as_json'],
              ...
              'procgraph_robotics': {'blocks': ['pose2commands',
                                     ...
                                     'requires': {'snp_geometry': ['snp_geometry']}},
