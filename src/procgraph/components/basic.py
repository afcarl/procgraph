...
def make_generic(name, num_inputs, num_outputs, operation, params={}, docs=None):
    ...
    class GenericOperation(Block):
        ...
        #desc, desc_rest = split_docstring(operation.__doc__)
...
def register_simple_block(function, name=None, num_inputs=1, num_outputs=1, params={}, doc=None):
    ...
    block = make_generic(name, num_inputs, num_outputs, function, params=params, docs=doc)
